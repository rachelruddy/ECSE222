...
-- HEX0[1]	=>  Location: PIN_AD29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX0[2]	=>  Location: PIN_AD30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX0[3]	=>  Location: PIN_AB28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX0[4]	=>  Location: PIN_AE29,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- enable	=>  Location: PIN_AA26,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \i1|Equal0~0_combout\ = ( !\i1|counter\(8) & ( !\i1|counter\(7) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \i1|ALT_INV_counter\(7),
	dataf => \i1|ALT_INV_counter\(8),
...
-- Equation(s):
-- \i1|counter~18_combout\ = ( \i1|Equal0~0_combout\ & ( \i1|Equal0~2_combout\ & ( (!\i1|Add0~121_sumout\ & (\reset~input_o\ & ((!\i1|Equal0~6_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~0_combout\ & ( \i1|Equal0~2_combout\ & ( 
-- (!\i1|Add0~121_sumout\ & \reset~input_o\) ) ) ) # ( \i1|Equal0~0_combout\ & ( !\i1|Equal0~2_combout\ & ( (!\i1|Add0~121_sumout\ & \reset~input_o\) ) ) ) # ( !\i1|Equal0~0_combout\ & ( !\i1|Equal0~2_combout\ & ( (!\i1|Add0~121_sumout\ & \reset~input_o\) ) 
-- ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010101010000000001010101000000000101010100000000010101000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_Add0~121_sumout\,
	datab => \i1|ALT_INV_Equal0~6_combout\,
	datac => \i1|ALT_INV_Equal0~1_combout\,
	datad => \ALT_INV_reset~input_o\,
	datae => \i1|ALT_INV_Equal0~0_combout\,
	dataf => \i1|ALT_INV_Equal0~2_combout\,
...
-- Equation(s):
-- \i1|counter[23]~1_combout\ = (!\reset~input_o\) # (\enable~input_o\)
...
-- Equation(s):
-- \i1|counter~16_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~113_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~113_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|counter[23]~0_combout\ = ( \i1|Equal0~0_combout\ & ( (!\reset~input_o\) # ((\i1|Equal0~6_combout\ & (\i1|Equal0~2_combout\ & \i1|Equal0~1_combout\))) ) ) # ( !\i1|Equal0~0_combout\ & ( !\reset~input_o\ ) )
...
-- Equation(s):
-- \i1|counter~14_combout\ = ( \reset~input_o\ & ( (!\i1|Add0~105_sumout\ & !\i1|Equal0~7_combout\) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_Add0~105_sumout\,
...
-- Equation(s):
-- \i1|Equal0~5_combout\ = ( \i1|counter\(6) & ( \i1|counter\(13) & ( (\i1|counter\(17) & (\i1|counter\(14) & (\i1|counter\(12) & \i1|counter\(15)))) ) ) )
...
PORT MAP (
	dataa => \i1|ALT_INV_counter\(17),
	datab => \i1|ALT_INV_counter\(14),
	datac => \i1|ALT_INV_counter\(12),
	datad => \i1|ALT_INV_counter\(15),
	datae => \i1|ALT_INV_counter\(6),
	dataf => \i1|ALT_INV_counter\(13),
...
-- pragma translate_on
PORT MAP (
	datab => \i1|ALT_INV_Add0~101_sumout\,
	datac => \i1|ALT_INV_Equal0~7_combout\,
	datad => \ALT_INV_reset~input_o\,
...
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_Equal0~7_combout\,
	datab => \ALT_INV_reset~input_o\,
...
-- Equation(s):
-- \i1|counter~11_combout\ = (!\i1|Equal0~7_combout\ & (\reset~input_o\ & !\i1|Add0~93_sumout\))
...
-- Equation(s):
-- \i1|counter~9_combout\ = (!\i1|Equal0~7_combout\ & (\reset~input_o\ & !\i1|Add0~85_sumout\))
...
PORT MAP (
	dataa => \i1|ALT_INV_Equal0~7_combout\,
	datab => \ALT_INV_reset~input_o\,
	datac => \i1|ALT_INV_Add0~85_sumout\,
	combout => \i1|counter~9_combout\);

-- Location: FF_X84_Y34_N53
...
-- Equation(s):
-- \i1|Equal0~4_combout\ = ( \i1|counter\(21) & ( \i1|counter\(23) & ( (\i1|counter\(20) & (\i1|counter\(22) & (\i1|counter\(19) & \i1|counter\(25)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_counter\(20),
	datab => \i1|ALT_INV_counter\(22),
	datac => \i1|ALT_INV_counter\(19),
	datad => \i1|ALT_INV_counter\(25),
	datae => \i1|ALT_INV_counter\(21),
	dataf => \i1|ALT_INV_counter\(23),
...
-- Equation(s):
-- \i1|counter~7_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~77_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~77_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|counter~6_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~73_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~73_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|counter~5_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~69_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~69_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|counter~3_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~61_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~1_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~0_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~61_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|counter~2_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~57_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~57_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
-- Equation(s):
-- \i1|Equal0~3_combout\ = ( \i1|counter\(2) & ( \i1|counter\(0) & ( (\i1|counter\(3) & (\i1|counter\(5) & (\i1|counter\(4) & \i1|counter\(1)))) ) ) )
...
PORT MAP (
	dataa => \i1|ALT_INV_counter\(3),
	datab => \i1|ALT_INV_counter\(5),
	datac => \i1|ALT_INV_counter\(4),
	datad => \i1|ALT_INV_counter\(1),
	datae => \i1|ALT_INV_counter\(2),
	dataf => \i1|ALT_INV_counter\(0),
...
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_Equal0~5_combout\,
...
-- Equation(s):
-- \i1|counter~19_combout\ = ( \i1|Equal0~6_combout\ & ( !\i1|Add0~125_sumout\ & ( (\reset~input_o\ & ((!\i1|Equal0~0_combout\) # ((!\i1|Equal0~2_combout\) # (!\i1|Equal0~1_combout\)))) ) ) ) # ( !\i1|Equal0~6_combout\ & ( !\i1|Add0~125_sumout\ & ( 
-- \reset~input_o\ ) ) )
...
PORT MAP (
	...
	datad => \i1|ALT_INV_Equal0~1_combout\,
	datae => \i1|ALT_INV_Equal0~6_combout\,
	dataf => \i1|ALT_INV_Add0~125_sumout\,
...
-- Equation(s):
-- \i1|Equal0~2_combout\ = ( !\i1|counter\(9) & ( !\i1|counter\(10) & ( (!\i1|counter\(11) & (!\i1|counter\(18) & (!\i1|counter\(24) & !\i1|counter\(16)))) ) ) )
...
PORT MAP (
	dataa => \i1|ALT_INV_counter\(11),
	datab => \i1|ALT_INV_counter\(18),
	datac => \i1|ALT_INV_counter\(24),
	datad => \i1|ALT_INV_counter\(16),
	datae => \i1|ALT_INV_counter\(9),
...
-- Equation(s):
-- \i1|Equal0~7_combout\ = ( \i1|Equal0~1_combout\ & ( \i1|Equal0~5_combout\ & ( (\i1|Equal0~2_combout\ & (\i1|Equal0~4_combout\ & (\i1|Equal0~0_combout\ & \i1|Equal0~3_combout\))) ) ) )
...
PORT MAP (
	...
	datab => \i1|ALT_INV_Equal0~4_combout\,
	datac => \i1|ALT_INV_Equal0~0_combout\,
	datad => \i1|ALT_INV_Equal0~3_combout\,
	datae => \i1|ALT_INV_Equal0~1_combout\,
...
-- Equation(s):
-- \i1|counter~8_combout\ = ( !\i1|Add0~81_sumout\ & ( (!\i1|Equal0~7_combout\ & \reset~input_o\) ) )
...
-- Equation(s):
-- \i1|Equal0~1_combout\ = ( !\i1|counter\(27) & ( !\i1|counter\(26) & ( (!\i1|counter\(28) & (!\i1|counter\(30) & (!\i1|counter\(31) & !\i1|counter\(29)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \i1|ALT_INV_counter\(28),
	datab => \i1|ALT_INV_counter\(30),
	datac => \i1|ALT_INV_counter\(31),
	datad => \i1|ALT_INV_counter\(29),
	datae => \i1|ALT_INV_counter\(27),
	dataf => \i1|ALT_INV_counter\(26),
	combout => \i1|Equal0~1_combout\);

-- Location: LABCELL_X85_Y35_N0
\i1|en_out_internal~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \i1|en_out_internal~0_combout\ = ( \i1|en_out_internal~q\ & ( \enable~input_o\ & ( (\i1|Equal0~1_combout\ & (\i1|Equal0~2_combout\ & (\i1|Equal0~0_combout\ & \i1|Equal0~6_combout\))) ) ) ) # ( !\i1|en_out_internal~q\ & ( \enable~input_o\ & ( 
-- (\i1|Equal0~1_combout\ & (\i1|Equal0~2_combout\ & (\i1|Equal0~0_combout\ & \i1|Equal0~6_combout\))) ) ) ) # ( \i1|en_out_internal~q\ & ( !\enable~input_o\ ) )
...
-- Equation(s):
-- \i2|count_reg[2]~0_combout\ = ( \i2|count_reg[1]~DUPLICATE_q\ & ( !\i2|count_reg\(2) $ (((!\i2|count_reg\(0)) # (!\i1|en_out_internal~q\))) ) ) # ( !\i2|count_reg[1]~DUPLICATE_q\ & ( \i2|count_reg\(2) ) )
...
-- Equation(s):
-- \i3|Mux6~0_combout\ = ( \i2|count_reg\(2) & ( (!\i2|count_reg\(0) & !\i2|count_reg\(1)) ) ) # ( !\i2|count_reg\(2) & ( (\i2|count_reg\(0) & !\i2|count_reg\(1)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \i2|ALT_INV_count_reg\(0),
	datac => \i2|ALT_INV_count_reg\(1),
	dataf => \i2|ALT_INV_count_reg\(2),
	combout => \i3|Mux6~0_combout\);

-- Location: LABCELL_X85_Y34_N18
\i3|Mux5~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \i3|Mux5~0_combout\ = ( \i2|count_reg\(2) & ( !\i2|count_reg[1]~DUPLICATE_q\ $ (!\i2|count_reg\(0)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \i2|ALT_INV_count_reg[1]~DUPLICATE_q\,
	datab => \i2|ALT_INV_count_reg\(0),
	dataf => \i2|ALT_INV_count_reg\(2),
...
-- Equation(s):
-- \i3|Mux4~0_combout\ = ( !\i2|count_reg\(2) & ( (\i2|count_reg[1]~DUPLICATE_q\ & !\i2|count_reg\(0)) ) )
...
-- Equation(s):
-- \i3|Mux3~0_combout\ = ( \i2|count_reg\(2) & ( !\i2|count_reg[1]~DUPLICATE_q\ $ (\i2|count_reg\(0)) ) ) # ( !\i2|count_reg\(2) & ( (!\i2|count_reg[1]~DUPLICATE_q\ & \i2|count_reg\(0)) ) )
...
-- Equation(s):
-- \i3|Mux2~0_combout\ = ( \i2|count_reg\(2) & ( (!\i2|count_reg[1]~DUPLICATE_q\) # (\i2|count_reg\(0)) ) ) # ( !\i2|count_reg\(2) & ( \i2|count_reg\(0) ) )
...
-- Equation(s):
-- \i3|Mux1~0_combout\ = ( \i2|count_reg\(2) & ( (\i2|count_reg[1]~DUPLICATE_q\ & \i2|count_reg\(0)) ) ) # ( !\i2|count_reg\(2) & ( (\i2|count_reg\(0)) # (\i2|count_reg[1]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \i3|Mux0~0_combout\ = ( \i2|count_reg\(2) & ( (\i2|count_reg[1]~DUPLICATE_q\ & \i2|count_reg\(0)) ) ) # ( !\i2|count_reg\(2) & ( !\i2|count_reg[1]~DUPLICATE_q\ ) )
